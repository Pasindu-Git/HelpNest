...
const StudentRegisteredSessions = () => {
  ...
  const confirmRegistration = async () => {
    ...
    try {
      ...
      showNotificationMessage(
        `Successfully registered for "${selectedSession.subject}"`,
        "success"
      );
                                  ...
                                  {Array.from({ length: 5 }, (_, index) => {
                                    ...
                                    return (
                                      <button
                                        ...
                                        onClick={() =>
                                          submitSessionRating(session, starValue)
                                        }
          ...
          <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
            ...
            <div className="p-6 space-y-4">
              <div className="bg-gradient-to-r from-[#22C55E]/10 to-[#06B6D4]/10 p-4 rounded-xl">
                ...
                <p className="text-sm">
                  <strong>Time:</strong> {selectedSession.time} ({selectedSession.duration} hours)
                </p>
                <p className="text-sm">
                ...
                <p className="text-sm">
                  ...
                  {selectedSession.maxParticipants - selectedSession.currentParticipants} seats
                </p>
              </div>
