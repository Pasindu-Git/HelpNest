...
public class FeedbackController {
    ...
    public FeedbackModel updateStatus(@PathVariable Long id, @RequestBody Map<String, String> statusUpdate) {
        ...
        if (updatedFeedback.getEmail() != null && !updatedFeedback.getEmail().isBlank()) {
            emailService.sendFeedbackStatusUpdateEmail(
                    updatedFeedback.getEmail(),
                    updatedFeedback.getStudentName(),
                    updatedFeedback.getCategoryName(),
                    updatedFeedback.getStatus(),
                    updatedFeedback.getAdminNote()
            );
        }
